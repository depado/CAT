...
try:
    # try to use python2 module
    from urllib2 import Request, urlopen, URLError
except ImportError:
    # otherwise, use python3 module
...
class Recognizer(AudioSource):
    ...
    def __init__(self, language="en-US", key="AIzaSyBU9gYzVzqbgp9B94DrJ6GUugHDaygEsEw"):
        """
    ...
    def samples_to_flac(self, source, frame_data):
        ...
        with io.BytesIO() as wav_file:
            ...
            try:
                # note that we can't use context manager due to Python 2 not supporting it
        ...
        if flac_converter is None:
            ...
            if system == "Windows" and platform.machine() in ["i386", "x86", "x86_64", "AMD64"]:
    ...
    def recognize(self, audio_data, show_all=False):
        ...
        if len(actual_result["alternative"]) == 1:
